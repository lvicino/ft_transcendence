...
export default function Privacy() {
  ...
  const page = t('privacy', { returnObjects: true }) as LegalPageData;
      ...
      <Card className="p-6 sm:p-8 border-white/10 bg-black/40 backdrop-blur-xl">
        <header className="mb-8 space-y-3 border-b border-white/10 pb-6">
          ...
          <h1 className="text-3xl font-black uppercase tracking-tight text-white">
            {page?.meta?.title ?? 'Privacy Policy'}
          </h1>
          <p className="text-sm leading-6 text-white/65">
            {page?.meta?.description ?? 'This page explains what data may be processed...'}
          </p>
